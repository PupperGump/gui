...
text_props::text_props(sf::Text& t)
{
    ...
    character_size = t.getCharacterSize();
}
...
namespace sf
{
    ...
    {
        // This is gonna provide the basis for center and right alignment. By inserting newlines properly it separates lines as needed, and ensureGeometryUpdate() will position each line accordingly, hopefully.

        // From the beginning, just go along the string until the given character's position is greater than width. Insert newline, set newline as next start position, and repeat until reaching the last character. Ignore spaces for now.

        // New plan, find the dimensions of the lines like before. This time, be much more efficient and organized.
        
        // This function will simply change a member variable to some enum
    }
