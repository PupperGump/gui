    ...
    enum class Align
{
    ...
    public:
        ...
        /// 
        /// \param alignment enum Align value for left, right, or center alignment
        /// \param width How far from the text's position to line-wrap
        /// 
        /// \return true if it needed to align, otherwise false
        /// </summary>
        void align(Align alignment = Align::LEFT, float width = 200.f);
