...
public:
	...
	virtual void set_padding(sf::Vector2f padding, bool affect_bound = 1);
...
public:
	...
	bool object_focused = 0; // Flag to prevent multiple objects being interacted with at once
	int next_bind_vector = 1; // objects[0] is default vector and each bind() call increments this by 1.
	sf::RenderWindow* window = NULL;
	ObjVec objects;
	std::vector<sf::Font> fonts;
	sf::String keyboard_input;

	sf::Vector2f offset; // For set_position() cause i objects can't see anything apparently
	Object* caller = NULL; // For recursive methods, to catch infinite loops
